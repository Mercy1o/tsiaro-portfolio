      ...
      {items.map((project) => (
        ...
        >
          ...
          <div className="md:col-span-6">
            <h3 className="text-3xl font-medium tracking-[-.04em] md:text-5xl lg:text-6xl">
              {project.title}
            </h3>
          ...
          <div className="md:col-span-3">
            <p className="font-mono text-[10px] uppercase tracking-[.16em] text-black/45">
              {project.category}
            </p>
          </div>
          ...
          <div className="flex items-center justify-between md:col-span-2 md:justify-end">
            ...
            <span
              className="ml-8 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"
              aria-hidden="true"
            >
              ↗
            </span>
