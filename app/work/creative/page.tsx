      ...
      <div className="mx-auto max-w-[1600px]">
        <header className="mb-12 border-b border-[#737873]/16 pb-8 md:mb-16 md:pb-10">
          <div className="flex items-start justify-between gap-6">
            <div>
              <p className="accent-rust font-mono text-[9px] uppercase tracking-[.22em]">WORK / 02</p>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-12 md:items-end">
            ...
            <Link href="/work/design" className="accent-brown font-mono text-[9px] uppercase tracking-[.18em] transition-opacity hover:opacity-50 md:col-span-3 md:col-start-10 md:text-right">Design →</Link>
          </div>
        </header>
